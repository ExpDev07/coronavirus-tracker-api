...
class Country:
    ...
    def get_country_code(self):
        ...
        Defaults to "XX".
        """
        country_code = COUNTRY_NAME__COUNTRY_CODE.get(self.get_country(), DEFAULT_COUNTRY_CODE)
        if country_code == DEFAULT_COUNTRY_CODE:
            # log at sub DEBUG level
            self.LOGGER.log(5, f"No country code found for '{self.country}'. Using '{country_code}'!")

        return country_code
    
    def get_default_country_code(self):
        """
        Return default country code (XX)
        """
