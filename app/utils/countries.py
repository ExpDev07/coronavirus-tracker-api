...
class CountryCodeProvider:
    ...
    def __new__(cls, *args, **kwargs):
        with cls._lock:
            if not cls._instance:
                cls._instance = super(CountryCodeProvider, cls).__new__(
                    cls, *args, **kwargs)
    ...
    def country_code(self, value):
        ...
        Defaults to "XX".
        """
        code = self._COUNTRY_NAME__COUNTRY_CODE.get(value, self._DEFAULT_COUNTRY_CODE)
        if code == self._DEFAULT_COUNTRY_CODE:
            # log at sub DEBUG level
            LOGGER.log(5, f"No country code found for '{value}'. Using '{code}'!")
