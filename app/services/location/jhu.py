...
from . import ILocationService, LocationService

LOGGER = logging.getLogger("services.location.jhu")
PID = os.getpid()


class JhuLocationService(ILocationService):
    """
...
'''DUPLICATION TO MAKE THIS COMPATIBLE WITH V1.PY AND NOT BREAK FUNCTIONALLITY'''
@cached(cache=TTLCache(maxsize=4, ttl=1800))
